...
<template>
  <div class="myems-page stats-view">
    ...
    >
      <template #header>
        <div class="stats-anomaly-header">
          <div
          ...
          <div class="stats-anomaly-header-title">
            用电异常提示
          </div>
        </div>
      </template>
      ...
      <template #footer>
        <el-button @click="dismissAnomalyDialog(false)">知道了</el-button>
        <el-button type="primary" @click="goAnomalyDetail">查看异常明细</el-button>
      </template>
    </el-dialog>

    <div class="page-head page-head--end">
      <el-button :icon="InfoFilled" @click="zScoreFormulaDialogVisible = true">
        Z-score 异常检测说明
      </el-button>
    </div>

    <el-dialog
      v-model="zScoreFormulaDialogVisible"
      title="用电异常 · Z-score 检测说明"
      width="560px"
      align-center
      destroy-on-close
    >
      ...
      <template #footer>
        <el-button type="primary" @click="zScoreFormulaDialogVisible = false">知道了</el-button>
      </template>
    </el-dialog>
        ...
        <el-tab-pane label="用电异常" name="anomalies">
          <div v-loading="loading" class="detail-tab">
            <div class="anomaly-tab-head">
              <span class="anomaly-tab-hint">基于筛选时段市电 hourly z-score</span>
              <el-button :icon="InfoFilled" text type="primary" @click="zScoreFormulaDialogVisible = true">
                Z-score 说明
              </el-button>
            </div>
            <el-alert
...
:deep(.stats-anomaly-dialog) {
  border-radius: 14px;
}

:deep(.stats-anomaly-dialog .el-dialog__header) {
  margin: 0;
  padding: 18px 20px 0;
}

:deep(.stats-anomaly-dialog .el-dialog__body) {
  padding: 12px 20px 8px;
}

:deep(.stats-anomaly-dialog .el-dialog__footer) {
  padding: 8px 20px 18px;
  border-top: 1px solid #f0f2f5;
}

.stats-anomaly-header {
  display: flex;
  align-items: center;
  gap: 12px;
}
