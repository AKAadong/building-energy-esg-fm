      ...
      <el-form label-width="0" class="toolbar-form" @submit.prevent>
        <el-row :gutter="[10, 8]">
          ...
          <el-col :xs="24" :sm="12" :md="5">
            <el-form-item>
              <el-select v-model="compareType" placeholder="对比 · 无 / 上周同期" class="w-full" size="small">
                <el-option label="无" value="none" />
                <el-option label="上周同期（−7 天）" value="week_prev" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="5">
            <el-form-item>
              <el-select v-model="timeSpan" placeholder="粒度 · 小时" class="w-full" size="small">
    ...
    <div class="myems-section">
      <div class="myems-section-head">
        ...
        <span class="section-hint">
          建筑 {{ chartBuildingId || '—' }}
          <template v-if="compareType === 'week_prev'"> · 紫虚线=对标样本均时 · 绿虚线=上周同期</template>
          <template v-else> · 紫虚线=对标样本均时</template>
        </span>
      </div>
    ...
    <div class="myems-section">
      ...
      <div class="table-wrap">
        <el-table
          v-loading="loading"
          :data="tableData"
          class="data-table data-table--borderless"
          :height="tableHeight"
