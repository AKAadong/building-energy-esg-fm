...
const openeds = ref(['grp-analysis', 'grp-decision'])
  ...
  <el-container class="ems-shell">
    <el-aside class="ems-aside" :width="asideWidth">
        ...
        >
          ...
          <el-sub-menu index="grp-analysis">
            <template #title>
              ...
              <span class="menu-label">用能分析</span>
            </template>
            <el-menu-item index="/energy">
              <span class="sub-label">能源明细</span>
            </el-menu-item>
          ...
          <el-menu-item index="/twin">
            ...
            <span class="menu-label">孪生与现场</span>
          </el-menu-item>

          <el-sub-menu index="grp-decision">
            <template #title>
              <el-icon><Odometer /></el-icon>
              <span class="menu-label">决策支持</span>
            </template>
          ...
          <el-menu-item index="/pricing">
            ...
            <span class="menu-label">产品与收费</span>
          </el-menu-item>

          <el-menu-item index="/admin" class="ems-menu-admin">
      ...
      <div class="ems-aside-foot">
        ...
        <span v-if="!collapsed" class="foot-text">总览 · 用能分析 · 智慧运维</span>
      </div>
    </el-aside>
